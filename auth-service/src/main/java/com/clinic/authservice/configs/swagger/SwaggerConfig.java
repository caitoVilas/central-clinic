package com.clinic.authservice.configs.swagger;
...
@OpenAPIDefinition(
        info = @Info(
                title = "Central-Clinic / Auth Services",
                version = "1.0.0",
                description = "Central-Clinic Authentication and Authorization API Documentation",
